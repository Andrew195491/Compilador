...
{
       0,    47,    47,    54,    56,    60,    70,    79,    92,   114,
     120,   128,   134,   143,   152,   158,   167,   173,   179,   185,
     195,   205,   215,   230,   243,   249,   255,   261,   267
};
#endif
...
#line 79 "parser_latino.y"
    {
        ...
        if ((yyvsp[(1) - (1)].simbolo).valor != NULL) {
